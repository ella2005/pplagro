...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 06 Des 2020 pada 03.53
...
--
-- Dumping data untuk tabel `cek_soal`
--
...
(1, 1, 'Untuk media tanam dapat dengan mencampurkan pasir,tanah,pupuk kompos atau pupuk kandang dengan komposisi', '1:1:1', '2:1:2', '1:2:2', '1:1:1', '2020-11-28 05:41:01', '2019-11-27 09:46:26', '0.2', '0.2', '0.2'),
(2, 1, 'Untuk Jarak antara tiang panjat adalah', '2 m', '3 m dan diantara baris dibuatkan drainase untuk menyerap air yang berlebihan', '4 m', '3 m dan diantara baris dibuatkan drainase untuk menyerap air yang berlebihan', '2020-11-28 05:41:39', '2019-11-27 09:44:03', '0.2', '0.2', '0.2'),
(3, 1, 'Untuk menambah kalsium pada tanah maka dilakukan', 'Menambahkan kapur atau dolomit kira-kira 300 gr', 'Menambahkan pupuk', 'Menambahkan air', 'Menambahkan kapur atau dolomit kira-kira 300 gr', '2020-11-28 05:42:08', '2019-11-27 09:49:19', '0.2', '0.2', '0.2'),
(4, 1, 'Berapa diameter batang yang benar untuk digunakan sebagai calon bibit buah naga?', '8 cm dan batang pernah berbuah 3-4 kali', '8 cm dan batang tidak pernah berbuah', '8 cm dan batang sudah tua', '8 cm dan batang pernah berbuah 3-4 kali', '2020-11-28 05:42:30', '2019-11-27 09:26:31', '0.2', '0.2', '0.2'),
(5, 1, 'Berapa panjang kira-kira batang tanaman yang dijadikan calon bibit buah naga?', '20-60 cm', '80-120 cm', '100-140 cm', '80-120 cm', '2020-11-28 05:42:51', '2019-11-27 09:29:21', '0.2', '0.2', '0.2'),
(6, 2, 'aaa', 'vv', 'cc', 'dd', 'cc', '2020-11-28 07:09:17', '2020-11-28 00:05:08', NULL, NULL, NULL),
(7, 2, 'sebutkan huruf di kata pelangi', 'q', 'v', 'c', 'c', '2020-11-28 07:09:25', '2020-11-28 00:04:58', NULL, NULL, NULL);
...
(5136, 'admin', 'zzz', 'asasas', 'kntl@gmail.com', NULL, '$2y$10$LNiIXadHXFXuSMvKMJoCduXgfNEfpqktJ/Qnn89ufZn6/r/gmc.9.', NULL, '2019-10-08 21:01:19', '2019-10-08 21:01:19'),
(6292, 'admin', 'taufan maulana', 'taufan123', 'taufan@gmail.com', NULL, '$2y$10$YzzjZFlG56drv7QkJ0OEsup/V9OUp6hdaxpJgP62tymVHKAvO1N8.', NULL, '2019-10-08 20:47:57', '2019-10-08 20:47:57'),
